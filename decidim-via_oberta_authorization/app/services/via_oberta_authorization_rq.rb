...
class ViaObertaAuthorizationRq
  # TODO: extract to ViaObertaAuthorizationConfig
  URL = "https://serveis3-pre.iop.aoc.cat/siri-proxy/services/Asincron?wsdl"
  ...
  def send_rq(document_type:, id_document:, birthdate:)
    request = ::ViaObertaAuthorization::ViaObertaData.new(document_type, id_document, birthdate)
